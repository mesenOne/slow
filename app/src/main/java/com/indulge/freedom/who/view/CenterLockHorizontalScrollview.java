...
public class CenterLockHorizontalScrollview extends HorizontalScrollView {
	...
	public void setAdapter(Context context, GalleryAdapter mAdapter) {
	...
	private void fillViewWithAdapter(GalleryAdapter mAdapter)
...
//		view.setBackgroundColor(Color.BLUE);
		...
		int scrollX = (view.getLeft() - (screenWidth ))
				+ (view.getWidth());
