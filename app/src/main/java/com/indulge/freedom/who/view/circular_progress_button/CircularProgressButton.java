package com.indulge.freedom.who.view.circular_progress_button;
...
public class CircularProgressButton extends Button {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        setPadding(0,0,0,Tools.PXtoDP(context,18));
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int errorStateSelector = attr.getResourceId(R.styleable.CircularProgressButton_cpb_selectorError,
                    R.color.cpb_idle_state_selector); //cpb_error_state_selector
