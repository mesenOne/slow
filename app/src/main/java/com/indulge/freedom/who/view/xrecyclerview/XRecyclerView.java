...
import com.indulge.freedom.who.adapter.ViewHolder;
...
public class XRecyclerView extends RecyclerView implements Scrollable {
    ...
    private static final float DRAG_RATE = 1.9f;
