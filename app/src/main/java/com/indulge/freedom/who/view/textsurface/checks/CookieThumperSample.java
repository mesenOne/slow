...
import com.indulge.freedom.who.view.textsurface.animations.Parallel;
...
public class CookieThumperSample {
	...
	public static void play(TextSurface textSurface, AssetManager assetManager) {
		...
		final Typeface robotoBlack = Typeface.createFromAsset(assetManager, "fonts/MagmaWave.ttf"); // NES_Controller_MrShrike.ttf
		...
		Text textDaai = TextBuilder
				...
				.setSize(60)
				.setAlpha(0)
//				.setColor(Color.parseColor("#c110b3a4"))
